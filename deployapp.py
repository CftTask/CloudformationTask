...
def run(args):
    ...
    parameter_data = [
        ...
        {"ParameterKey": "KeyName", "ParameterValue": args.ec2keypair},
        {"ParameterKey": "OperatorEMail", "ParameterValue": "t@t.com"},
        {"ParameterKey": "SSHLocation", "ParameterValue": "0.0.0.0/0"},
        {"ParameterKey": "AMIID", "ParameterValue": args.amiid},
    ]
...
def main():
    ...
    p.add_argument("--ec2keypair", "--ec2keypair", required=True, help="ec2 key pair name")
    p.add_argument("--amiid", "--amiid", required=True, help="ami id")
